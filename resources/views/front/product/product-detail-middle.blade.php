        ...
        <div class="row">
            <div class="tabs col-lg-9 col-md-7 ">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#reviews">Write
                            Your Own Review<span class="count-comment">
                                (1)</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="tab-content">
                    ...
                    <script type="text/javascript">
                        var novproductcomments_controller_url =
                            'http://demo.bestprestashoptheme.com/savemart/ar/module/novproductcomments/default';
                    ...
                    <div class="tab-pane fade in" id="reviews">
                            ...
                            <div class="comment clearfix">
                                <div class="comment_author">
                                    ...
                                    <div class="comment_author_infos">
                                        ...
                                        <div class="date-comment">2018-08-07</div>
                                    </div>
                                </div>
                                <div class="comment_details">
                                    ...
                                    <p>fdfsd</p>
                                    <ul>
                                        <li>1 out of 2 people found this review
                                            useful.</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <p class="text-center mt-10">
                            <a id="new_comment_tab_btn" class="open-comment-form btn btn-default" data-toggle="modal"
                                data-target="#new_comment_form" href="#">Write your
                                review !</a>
                        </p>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title text-xs-center"><i class="fa fa-edit"></i> Write
                                        your
                                        review</h4>
                                    ...
                                    <form id="id_new_comment_form" action="#">
                                        <div class="product row no-gutters">
                                            ...
                                            <div class="product_desc col-8">
                                                <p class="product_name">Nullam sed
                                        ...
                                        <div class="new_comment_form_content">
                                            ...
                                            <ul id="criterions_list">
                                                <li>
                                                    ...
                                                    <div class="star_content">
                                                        ...
                                                        <div class="star star_on"><a title="2">2</a>
                                                        </div>
                                                        <div class="star star_on"><a title="3">3</a>
                                                        </div>
                                            ...
                                            <label for="comment_title">Title for
                                                your review<sup class="required">*</sup></label>
                    ...
                    <div class="tab-pane fade in" id="tab-custom">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Nulla fringilla congue ultricies. Nam cursus velit in
                            erat rutrum, sed ullamcorper nunc dictum. Sed volutpat,
                            mauris ac pulvinar lobortis, felis ipsum commodo diam,
                            nec vehicula lorem dui eu urna. Proin sodales nisi vitae
                            diam congue, viverra congue metus iaculis. Pellentesque
                            ultricies erat purus, ut commodo sapien imperdiet quis.
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Maecenas eu sagittis nibh, sed scelerisque nunc.
                            Pellentesque habitant morbi tristique senectus et netus
                            et malesuada fames ac turpis egestas. Sed elit tortor,
                            scelerisque id pellentesque nec, facilisis ut urna.
                            Etiam scelerisque eleifend eros. Donec consectetur
