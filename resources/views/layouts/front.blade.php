...
<head>
    ...
    {{--
    <link rel="stylesheet"
        href="http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/cache/theme-526bb624.css"
    ...
    <script type="text/javascript">
        ...
        var prestashop = {
            ...
            "urls": {
                ...
                "actions": {
                    "logout": "http:\/\/demo.bestprestashoptheme.com\/savemart\/en\/?mylogout="
                },
                "no_picture_image": {
                    "bySize": {
                        "cart_default": {
            ...
            "breadcrumb": {
                "links": [{
                    "title": "Home",
                    "url": "http:\/\/demo.bestprestashoptheme.com\/savemart\/en\/"
                }],
                "count": 1
            },
            "link": {
    ...
    <style type="text/css">
        ...
        #popup-subscribe .modal-dialog .modal-content {
            background-image: url("{{ asset('front') }}/modules/novthemeconfig/images/newsletter_bg-1.png");
        }
    ...
    <body id="index" class=" {{currentLocale() == 'ar' ? 'lang-ar lang-rtl' : 'lang-en'}}  country-gb currency-gbp layout-full-width page-index tax-display-enabled">
            ...
            <div>
                <div id="_mobile_account_list">
                    <div class="account-list-content">
                        <div>
                            <a class="login" href="login-1.html" rel="nofollow"
                                title="Log in to your customer account"><i class="fa fa-sign-in"></i>Sign in</a>
                        </div>
                        <div>
            ...
            <div class="w-100">
                <div class="item-currency current">
                    <a title="British Pound" rel="nofollow"
                        href="index-1.htm?home=home_3&amp;SubmitCurrency=1&amp;id_currency=1">British Pound:
                        GBP</a>
                </div>
            ...
            <div class="w-100">
                <div class="item-language current">
                    <a href="index.htm?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2"
                            src="{{ asset('front') }}/img/l/1.jpg" alt="English (English)" width="16"
                            height="11"><span>English</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/fr/?home=home_3"
                        class="d-flex align-items-center"><img class="img-fluid mr-2"
                            src="{{ asset('front') }}/img/l/2.jpg" alt="Français (French)" width="16"
                            height="11"><span>Français</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3"
                        class="d-flex align-items-center"><img class="img-fluid mr-2"
                            src="{{ asset('front') }}/img/l/3.jpg" alt="Español (Spanish)" width="16"
                            height="11"><span>Español</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/it/?home=home_3"
                        class="d-flex align-items-center"><img class="img-fluid mr-2"
                            src="{{ asset('front') }}/img/l/4.jpg" alt="Italiano (Italian)" width="16"
                            height="11"><span>Italiano</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/pl/?home=home_3"
                        class="d-flex align-items-center"><img class="img-fluid mr-2"
                            src="{{ asset('front') }}/img/l/5.jpg" alt="Polski (Polish)" width="16"
                            height="11"><span>Polski</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3"
                        class="d-flex align-items-center"><img class="img-fluid mr-2"
                            src="{{ asset('front') }}/img/l/6.jpg" alt="اللغة العربية (Arabic)" width="16"
                            height="11"><span>اللغة العربية</span></a>
                </div>
            </div>
        </div>
...
<div id="stickymenu_bottom_mobile" class="d-flex align-items-center justify-content-center hidden-md-up text-center">
    ...
    <div class="stickymenu-item"><a href="login-2.html"><i
                class="zmdi zmdi-favorite-outline"></i><span>Wishlist</span></a>
    </div>
